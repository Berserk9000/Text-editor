Create a text/code editor that functions on a single page, follows PWA criteria, and works offline. Webpack IndexedDP Node and Express was used to make the following application.
